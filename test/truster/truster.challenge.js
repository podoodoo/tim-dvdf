...
const { TrusterABI } = require("../../constants/index.js")
...
describe("[Challenge] Truster", function () {
    ...
    it("Execution", async function () {
        ...
        const iface = new ethers.utils.Interface(TrusterABI.abi)
        const encodedTransferFrom = iface.encodeFunctionData("approve", [
            player.address,
            TOKENS_IN_POOL
        ])
